						...
						<div class="row">
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="<?= base_url() ?>template/front-end/">
											<div class="footer_logo_text">SMA<span>1</span></div>
										</a>
									</div>
									<div class="footer_about_text">
										<p>website sederhana ini di buat oleh mahasiswa dcc :apregi prata yuda sebagai memenuhi tugas kuliah web 2</p>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									<div class="footer_title">Contact Kami</div>
									<div class="footer_contact_info">
										<ul>
											<li>Email: Info.apregiagatha@gmail.com</li>
											<li>Phone:  +(62) <?= $setting->no_telp?></li>
											<li><i class="fa fa-map-marker"></i> <?= $setting->alamat?></li>
										</ul>
									</div>
								</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://apregi.com" target="_blank">apregiweb</a>
...
<script src="<?= base_url() ?>template/front-end/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
