<div class="col-md-12">
            <div class="card card-success">
              ...
              <div class="card-body">
               <?php
                   ...
                   echo validation_errors('<div class="alert alert-danger alert-dismissible mr-5 ml-5">
            ...
            <input type="text" name="judul_berita" id="judul_berita" class="form-control" placeholder="judul berita" required="">
          </div>
        </div>
          ...
          <div class="form-group">
            ...
            <textarea name="isi_berita"  id="editor" class="form-control" rows="12" ></textarea> 
          </div>
        </div>
