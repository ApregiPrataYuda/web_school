			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_subtitle"><p>Lihat pengumuman dan jika ada yg perlu di download silakan ke halaman download terima kasih</p></div>
					</div>
				</div>
			</div>
			<div class="row about_row">
				...
				<div class="col-lg-4 about_col about_col_left">
					<div class="about_item">
						<div class="about_item_image text-center"><img src="<?= base_url('gambar_pengumuman/'.$value->gambar)?>" style="background: yellow;" width="200px" height="100%"></div>
						<div class="about_item_title "><a href=""><?= $value->nama_pengumuman ?></a></div>
