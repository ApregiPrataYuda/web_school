  ...
  <?php  foreach ($guru as $key => $value) { ?>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="<?= base_url('fotog/'.$value->foto) ?>" alt=""></div>
						<div class="team_body">
							<div class="team_title"><a href=""><?= $value->nama?></a></div>
							<div class="team_title"><a href="#"></a><?= $value->tempat_lahir?>,<?= $value->tgl_lahir?></div>
							<div class="team_title"><a href="#"></a><?= $value->pendidikan?></div>
							<div class="team_title"><a href="#"></a><?= $value->nama_mapel?></div>
